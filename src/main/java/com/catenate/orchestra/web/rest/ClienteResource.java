...
/**
 * REST controller for managing {@link com.catenate.orchestra.domain.Cliente}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ClienteResource {
     ...
     */
    @GetMapping("/clientes")
    public List<Cliente> getAllClientes(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
    ...
    public ResponseEntity<Cliente> getCliente(@PathVariable Long id) {
        ...
        Optional<Cliente> cliente = clienteRepository.findOneWithEagerRelationships(id);
