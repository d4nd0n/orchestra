...
class ClienteResourceIT {
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente().nomeCliente(DEFAULT_NOME_CLIENTE);
        return cliente;
    }
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        Cliente cliente = new Cliente().nomeCliente(UPDATED_NOME_CLIENTE);
        return cliente;
    }
    ...
    void createCliente() throws Exception {
        ...
        assertThat(testCliente.getNomeCliente()).isEqualTo(DEFAULT_NOME_CLIENTE);
    }
    ...
    void putNewCliente() throws Exception {
        ...
        updatedCliente.nomeCliente(UPDATED_NOME_CLIENTE);
        ...
        Cliente testCliente = clienteList.get(clienteList.size() - 1);
        assertThat(testCliente.getNomeCliente()).isEqualTo(UPDATED_NOME_CLIENTE);
    }
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.nomeCliente(UPDATED_NOME_CLIENTE);
